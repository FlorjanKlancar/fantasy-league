      ...
      <div className="h-full">
        {selectedList.length ? (
          <div className="space-y-5">
            ...
            <progress
              className="progress progress-primary w-full border border-slate-700"
          ...
          <div className="mt-5 flex h-full w-full flex-col items-center justify-center rounded-lg border-2 border-dashed border-slate-500 p-12 text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
