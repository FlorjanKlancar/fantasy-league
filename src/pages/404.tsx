          ...
          <main className="sm:flex">
            ...
            <div className="sm:ml-6">
              ...
              <div className="mt-10 flex space-x-3 sm:border-l sm:border-transparent sm:pl-6">
                <button
                  className="btn-md btn border-primary bg-primary text-white hover:bg-primary/60"
                  onClick={pushToHomepage}
                >
                  Go back home
                </button>
                <button className="btn-md btn border-secondary bg-secondary text-white hover:bg-secondary/60">
                  Contact Support
                </button>
              </div>
            </div>
